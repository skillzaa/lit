...
class BilzaaTextArea extends LitElement {
static get styles() {
return css`
  #theElement{
  width:100%;
...
focusHandler(e) {  
let event = new CustomEvent('bilazaa-ta-focus', {
  bubbles: true,
...
focusOutHandler(e) {  
let event = new CustomEvent('bilazaa-ta-focusout', {
  bubbles: true,
...
customElements.define('bilzaa-textbox', BilzaaTextArea);